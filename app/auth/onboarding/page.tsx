      ...
      if (!user) {
        ...
        if (response.ok) {
          ...
          if (data.onboardingCompleted) {
            ...
            // #region agent log
            fetch("http://127.0.0.1:7242/ingest/bc0a0876-b22a-43a2-8bb5-3b0f14e7c9c0", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ location: "auth/onboarding:redirect", message: "Already onboarded, redirecting", data: { redirect, target }, timestamp: Date.now(), hypothesisId: "H3" }) }).catch(() => {})
            // #endregion
            router.push(target)
            return
          }
