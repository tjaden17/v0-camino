...
export default function ProfilePage() {
  ...
  const handleCreateOrganization = async () => {
    // #region agent log
    fetch('http://127.0.0.1:7242/ingest/bc0a0876-b22a-43a2-8bb5-3b0f14e7c9c0',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({location:'profile/page.tsx:handleCreateOrganization:entry',message:'Create org clicked',data:{hasUserId:!!userId,newOrgNameLen:newOrgName?.length,trimmed:newOrgName?.trim()?.length},timestamp:Date.now(),hypothesisId:'H1'})}).catch(()=>{})
    // #endregion
    if (!userId || !newOrgName.trim()) return

    try {
      // #region agent log
      fetch('http://127.0.0.1:7242/ingest/bc0a0876-b22a-43a2-8bb5-3b0f14e7c9c0',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({location:'profile/page.tsx:handleCreateOrganization:before-create',message:'Calling POST /api/user/organizations',data:{},timestamp:Date.now(),hypothesisId:'H3'})}).catch(()=>{})
      // #endregion
      ...
      const org = data as { id: string; name: string }
      // #region agent log
      fetch('http://127.0.0.1:7242/ingest/bc0a0876-b22a-43a2-8bb5-3b0f14e7c9c0',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({location:'profile/page.tsx:handleCreateOrganization:success',message:'Org created',data:{orgId:org?.id},timestamp:Date.now(),hypothesisId:'H5'})}).catch(()=>{})
      // #endregion
      ...
      // #region agent log
      fetch('http://127.0.0.1:7242/ingest/bc0a0876-b22a-43a2-8bb5-3b0f14e7c9c0',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({location:'profile/page.tsx:handleCreateOrganization:catch',message:'createOrganization threw',data:{errMsg:error instanceof Error?error.message:String(error)},timestamp:Date.now(),hypothesisId:'H4'})}).catch(()=>{})
      // #endregion
