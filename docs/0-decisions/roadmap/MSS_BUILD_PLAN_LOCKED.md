...
- Column: "Amount"
- Filter: Stage NOT IN ("Closed Won", "Closed - No Budget")
- Operation: SUM of Amount (after removing "AUD" prefix and commas)
- Format: "$X" (AUD)
- Expected value: Sum of all open deal amounts
...
- Source: zoho-crm-deals.csv
- Column: "Stage"
- Filter: Stage IN ("Closed Won", "Closed - No Budget") only
- Operation: COUNT(Stage = "Closed Won") / COUNT(Stage IN ("Closed Won", "Closed - No Budget"))
- Format: "X%"
- Note: "Closed - No Budget" = lost. No other closed-lost stages exist in data.
...
|------|------|-----------------|------------|
| Surge | CEO | Pipeline Value, Win Rate, Closed Revenue, Avg Sales Cycle | Win rate, sales |
...
- Prepare CEO demo (Pipeline Value, Win Rate, Closed Revenue, Avg Sales Cycle)
...
1. His pipeline value in AUD - and it matches what he sees in Zoho
